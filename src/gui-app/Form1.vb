...
Private Sub ComputeTraverse_Click() Handles btnCompute.Click
    ...
    For i As Integer = 0 To n - 1
        ...
        For Each a As Double In includedAngles
            ...
            ' Calculate correction per angle
            Dim angularCorrectionPerStation As Double = -angularMisclosure / n

            ' Apply the correction To the raw angles before computing bearings
            For i As Integer = 0 To n - 1
                includedAngles(i) += angularCorrectionPerStation
                Next
